...
<div class="container mt-4 justify-content-center d-flex flex-column" style="min-height: 80vh;min-height: 80dvh;">
    <h1 class="text-center text-success">LOGIN AS RECEIVER</h1>
    <?php
        include './database/errors.php';
        include './database/success.php';
    ?>
    <form class="p-2 needs-validation" action="<?php echo $_SERVER['PHP_SELF'].'?page=login_as_receiver'; ?>" method="POST" autocomplete="on"  novalidate>
        <div class="mb-3">
        ...
        <button type="submit" class="btn btn-primary" id="login_as_receiver" name="login_as_receiver">Login</button>
    </form>
</div>
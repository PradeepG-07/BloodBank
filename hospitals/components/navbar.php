    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav m-auto mb-lg-0 mb-2 align-items-center">
            ...
            <li class="nav-item">
                <a class="nav-link links" href="/BloodBank/hospitals/index.php">Dashboard</a>
            </li>
            <li class="nav-item">
                <a class="nav-link links" href="/BloodBank/hospitals/index.php?page=requests">Requests</a>
            </li>
            <li class="nav-item">
                <a class="nav-link links" href="/BloodBank/hospitals/index.php?page=blood_info">Blood_Info</a>
            </li>
        </ul>
        <ul class="nav nav-pills sm-d-flex justify-content-center lg-d-block gap-2">
            <li class="nav-item dropdown dropdown-center">
                <a class="nav-link dropdown-toggle text-truncate" style="max-width: 250px" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                  Logged in as: <i ><?php echo $_SESSION['hospital_name']?></i>
                </a>
